...
public class ReflectionRefractionTests {
	...
	public void twoSpheres() {
		...
		ImageWriter imageWriter = new ImageWriter("twoSpheres", 150, 150, 500, 500,9);
	...
	@Test
	public void twoSphereIntegration() {
		Scene scene = new Scene("Test scene");
		scene.set_camera(new Camera(new Point3D(0, 0, -1000), new Vector(0, 0, 1), new Vector(0, -1, 0)));
		scene.set_screenDistance(1000);
		scene.set_background(Color.BLACK);
		...
		scene.addGeometry(
				new Sphere(new Material(0.4, 0.3, 100, 0, 0), new Color(java.awt.Color.BLUE), 50,
						new Point3D(0, 0, 50)),
				new Sphere(new Material(0.5, 0.5, 100,0,0), new Color(java.awt.Color.RED), 25, new Point3D(70, -70, 50)),
				new Triangle(new Material(0, 0, 0, 0, 1), new Color(java.awt.Color.white), new Point3D(1500, 1500, 1500),
						new Point3D(-1500, -1500, 1500), new Point3D(670, -670, -3000))
				,
				new Triangle(new Material(0, 0, 0, 0, 1), new Color(java.awt.Color.pink), new Point3D(1500, 1500, 1500),
					new Point3D(-1500, -1500, 1500), new Point3D(-670,670, 3000))
				);
		...
		ImageWriter imageWriter = new ImageWriter("twoSpheresIntegration", 150, 150, 500, 500,9);
		Render render = new Render(imageWriter, scene);
	...
	public void twoSpheresOnMirrors() {
		...
		scene.set_screenDistance(10000);
		scene.set_background(Color.BLACK);
		...
		ImageWriter imageWriter = new ImageWriter("twoSpheresMirrored", 2500, 2500, 500, 500,9);
		Render render = new Render(imageWriter, scene);
	...
	public void trianglesTransparentSphere() {
		...
		ImageWriter imageWriter = new ImageWriter("shadow with transparency", 200, 200, 600, 600,9);
		Render render = new Render(imageWriter, scene);
